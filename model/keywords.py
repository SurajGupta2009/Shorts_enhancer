...
INFO_KEYWORDS = [
    "motivation", "motivated", "motivational", "discipline",
    "disciplined", "habit", "habits", "consistency",
    "consistent", "procrastination", "procrastinate", "focus",
    "willpower", "mindset", "routine", "goal",
    "goals", "journaling", "meditation", "stoicism",
    "stoic", "improve", "improvement", "growth",
    "politics", "political", "election", "elections",
    "voter", "voting", "parliament", "parliamentary",
    "constitution", "constitutional", "amendment", "democracy",
    "democratic", "government", "policy", "economy",
    "economic", "geopolitics", "diplomacy", "budget",
    "taxation", "census", "panchayat", "judiciary",
    "president", "assembly", "cabinet", "upsc",
    "ias", "national", "invention", "invented",
    "inventor", "innovation", "innovative", "idea",
    "ideas", "breakthrough", "discovery", "discovered",
    "origins", "origin", "engineering", "design",
    "prototype", "startup", "entrepreneur", "entrepreneurship",
    "revenue", "profit", "market", "customer",
    "strategy", "civilisation", "civilization", "empire",
    "dynasty", "colonial", "independence", "revolution",
    "treaty", "monarchy", "ancient", "medieval",
    "history", "historical", "archaeology", "explained",
    "explain", "explanation", "concept", "revision",
    "revise", "revised", "lecture", "lesson",
    "tutorial", "teach", "teacher", "teacher's",
    "class", "classes", "chapter", "topic",
    "syllabus", "note", "notes", "summary",
    "summarize", "recap", "definition", "define",
    "example", "exercise", "question", "problem",
    "solution", "solve", "derivation", "derive",
    "proof", "prove", "formula", "equation",
    "numerical", "diagram", "step", "steps",
    "method", "approach", "technique", "tip",
    "tips", "trick", "tricks", "shortcut",
    "hack", "hacks", "mistake", "mistakes",
    "understand", "learn", "learning", "study",
    "studies", "prepare", "preparation", "practice",
    "mock", "pyq", "paper", "exam",
    "exams", "test", "marks", "score",
    "topper", "rank", "cutoff", "merit",
    "viva", "semester", "grade", "board",
    "neet", "jee", "gate", "ssc",
    "cat", "cet", "cbse", "icse",
    "ncert", "iit", "aiims", "cuet",
    "ctet", "rrb", "bank", "police",
    "physics", "chemistry", "biology", "maths",
    "math", "mathematics", "science", "english",
    "grammar", "vocabulary", "pronunciation", "hindi",
    "geography", "economics", "polity", "civics",
    "accounting", "statistics", "algebra", "geometry",
    "calculus", "trigonometry", "probability", "mechanics",
    "thermodynamics", "optics", "organic", "inorganic",
    "physical", "anatomy", "physiology", "pharmacology",
    "pathology", "microbiology", "nursing", "medicine",
    "mbbs", "neuron", "cell", "dna",
    "genetics", "ecology", "botany", "zoology",
    "biochemistry", "biotechnology", "programming", "code",
    "coding", "python", "java", "javascript",
    "kotlin", "c++", "sql", "database",
    "dbms", "algorithm", "data", "structure",
    "complexity", "recursion", "pointer", "array",
    "string", "graph", "tree", "interview",
    "placement", "machine", "deep", "neural",
    "model", "dataset", "pipeline", "deploy",
    "docker", "software", "system", "architecture",
    "network", "security", "how", "why",
    "what", "when", "which", "difference",
    "versus", "vs", "compare", "reason",
    "cause", "effect", "analysis", "analyze",
    "breakdown", "decode", "fact", "facts",
    "myth", "truth", "research", "find",
    "beginner", "basic", "basics", "advanced",
    "fundamental", "core", "intuition", "behind",
    "inside", "working", "works", "work",
    "experiment", "demo", "career", "job",
    "salary", "skill", "finance", "financial",
    "money", "investment", "invest", "investing",
    "sip", "mutual", "fund", "stock",
    "tax", "insurance", "loan", "credit",
    "inflation", "gdp", "rbi", "health",
    "nutrition", "protein", "calorie", "medical",
    "doctor", "treatment", "recipe", "ingredient",
    "cook", "cooking", "knead", "knife",
    "guitar", "chord", "piano", "scale",
    "photography", "aperture", "shutter", "excel",
    "sheet", "pivot", "resume", "linkedin",
    "productivity", "education", "educational", "vacancy",
    "recruitment", "notification", "admit", "eligibility",
    "scholarship", "guide", "review", "specs",
    "benchmark", "comparison", "biomechanics", "cue",
    "form", "drill", "mobility", "warmup",
    "rep", "macro", "diet", "price",
    "cost", "laptop", "mobile", "phone",
    "gadget", "gear", "tool", "app",
    "website", "resource", "book", "books",
    "material", "pdf", "course", "coaching",
    "tuition", "doubt", "query", "answer",
    "timetable", "schedule", "concentration", "memory",
    "recall", "naukri", "sarkari", "result",
    "answerkey", "govt", "jobs", "post",
    "posts", "vacancies", "training", "workout",
    "plan", "planner", "master", "news",
    "announcement", "project", "report", "documentary",
    "robot", "robotics", "arduino", "electronics",
...
ENT_KEYWORDS = [
    "song", "songs", "music", "lyrical",
    "remix", "mashup", "jukebox", "audio",
    "cover", "singing", "sing", "singer",
    "beats", "lofi", "slowed", "reverb",
    "dance", "dancing", "choreography", "hook",
    "step", "performance", "routine", "adult",
    "xxx", "porn", "nude", "nudes",
    "naked", "sexy", "sexiest", "bikini",
    "lingerie", "bra", "cleavage", "boobs",
    "breast", "thirsttrap", "onlyfans", "bold",
    "sizzling", "sensual", "erotic", "milf",
    "bhabhi", "randi", "sex", "comedy",
    "funny", "joke", "jokes", "meme",
    "memes", "skit", "roast", "prank",
    "cringe", "laugh", "laughing", "haha",
    "lol", "fails", "fail", "blooper",
    "drama", "episode", "serial", "twist",
    "scene", "scenes", "climax", "trailer",
    "teaser", "movie", "movies", "film",
    "cinema", "actress", "actor", "celebrity",
    "gossip", "spotted", "pap", "reaction",
    "react", "reacting", "exposed", "vlog",
    "vlogs", "vlogger", "haul", "unboxing",
    "unbox", "tour", "shopping", "lookbook",
    "outfit", "makeup", "beauty", "skincare",
    "hair", "fashion", "nail", "glow",
    "challenge", "challenges", "day", "days",
    "hours", "gameplay", "gaming", "clutch",
    "montage", "noob", "pro", "game",
    "level", "skin", "lobby", "victory",
    "defeat", "highlights", "highlight", "goal",
    "penalty", "wicket", "six", "catch",
    "match", "prediction", "team", "viral",
    "trending", "reels", "status", "attitude",
    "sigma", "beast", "mood", "edits",
    ...
    "burger", "sad", "love", "broken",
    "heart", "emotional", "story", "stories",
    "friend", "friendship", "birthday", "wedding",
    "couple", "bhai", "yaar", "rashifal",
    "horoscope", "zodiac", "tarot", "kundli",
    "vastu", "numerology", "satta", "betting",
    "jackpot", "lottery", "crypto", "signal",
    "profit", "guaranteed", "sureshot", "trick",
    "double", "money", "keyboard", "typing",
    "sleepy", "night", "3am", "reel",
    "short", "shorts", "yt", "youtube",
    "instagram", "facebook", "whatsapp", "trend",
    "sound", "lyrics", "video", "clips",
    "clip", "full", "cashback", "discount",
    "coupon", "offer", "sale", "advertisement",
    "advert", "sponsored", "promoted", "preorder",
    "pre-book", "minecraft", "roblox", "freefire",
    "valorant", "pubg", "speedrun", "sweaty",
    "pvpers", "pvp", "frags", "trolling",
    "esports",
...
INFO_PHRASES = [
    "how to", "why do", "why does", "why is",
    "what is", "what are", "difference between", "step by step",
    "in 60 seconds", "in 2 minutes", "explained in", "one shot",
    ...
    "union budget", "freely available", "physics of", "physics behind",
    "science behind", "the science of", "maths behind", "chemistry of",
    "biology of", "answer key", "admit card", "last date",
    "cut off", "merit list", "result date", "exam date",
    "official update", "notification out", "application form", "hall ticket",
    "how does", "why do we", "why does a",
    "motivational speech", "motivation speech", "speech on", "how to make",
...
ENT_PHRASES = [
    "hot girl", "hot photoshoot", "bold scene", "link in bio",
    "only fans", "wait for it", "gone wrong", "part 2",
    "part 3", "full video", "must watch", "watch till end",
    "tag your", "best of", "too good", "so funny",
    "for the first time", "my reaction", "exposed", "viral video",
    "trending now", "no way", "oh my god", "who else",
    "what happens next", "you won't believe", "at 3am", "hits different",
    "semi nude", "hot girls", "thirst trap", "sexy video",
